	...
	public bool HandleSwi( uint comment )
	{
		...
		switch ( comment )
		{
			...
			case 0x0C: // CpuFastSet
				...
				{
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Cannot CpuSet from BIOS" );
					break;
				}

				uint alignmentMask = (Gba.Cpu.Registers[2] & (1u << 26)) != 0 ? 3u : 1u;
				if ( (Gba.Cpu.Registers[0] & alignmentMask) != 0 )
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Misaligned CpuSet source" );
				if ( (Gba.Cpu.Registers[1] & alignmentMask) != 0 )
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Misaligned CpuSet destination" );
			...
			case 0x10:
				...
				{
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad BitUnPack source" );
					break;
				}
				...
				{
					default:
						EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad BitUnPack destination" );
						goto case 0x2;
					case 0x2:
					case 0x3:
					case 0x6:
			...
			case 0x11:
				...
				{
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad LZ77 source" );
					break;
				}
				...
				{
					default:
						EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad LZ77 destination" );
						goto case 0x2;
					case 0x2:
					case 0x3:
					case 0x6:
			...
			case 0x13:
				if ( (Gba.Cpu.Registers[0] & 0x0E000000) == 0 )
				{
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad Huffman source" );
					break;
				}
				...
				{
					default:
						EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad Huffman destination" );
						goto case 0x2;
					case 0x2:
					case 0x3:
					case 0x6:
			...
			case 0x14:
				if ( (Gba.Cpu.Registers[0] & 0x0E000000) == 0 )
				{
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad RL source" );
					break;
				}
				...
				{
					default:
						EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad RL destination" );
						goto case 0x2;
					case 0x2:
					case 0x3:
					case 0x6:
			...
			case 0x16:
				if ( (Gba.Cpu.Registers[0] & 0x0E000000) == 0 )
				{
					EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad UnFilter source" );
					break;
				}
				...
				{
					default:
						EmuLog.Write( LogCategory.Bios, LogLevel.GameError, "Bad UnFilter destination" );
						goto case 0x2;
					case 0x2:
					case 0x3:
					case 0x6:
			...
			case 0x18:
				...
				break;
			case 0x19:
				EmuLog.Write( LogCategory.Bios, LogLevel.Stub, "Stub software interrupt: SoundBias (19)" );
				break;
			...
			case 0x2A: // SoundDriverGetJumpList
				...
				return false;
			default:
				EmuLog.Write( LogCategory.Bios, LogLevel.Stub, "Stub software interrupt: {0:X2}", comment );
				break;
		}
